...
- [x] **Phase 8 — Proactive speech**
  ...
  - [x] Remark on an unusually long jump - Flavor during a longer-than-normal hyperspace jump, fired once hyperspace has actually been entered rather than on the jump being initiated. Threshold is configurable but defaults to 20 seconds.
