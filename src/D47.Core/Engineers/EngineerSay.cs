...
/// <summary>The handful of phrases the Engineers tab and the engineers tools both use (Phase 28).</summary>
public static class EngineerSay
{
    /// <summary>A distance, at the precision anybody can act on.</summary>
    ...
    /// <summary>
    /// A jump count, hedged. "About", because the range is the ship's maximum and a real route bends
    /// around the stars that are actually there — a bare "3 jumps" claims a plotted route where this is
    /// a straight line divided by a number.
    /// </summary>
