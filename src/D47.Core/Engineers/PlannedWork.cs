...
/// <summary>
/// One planned thing that somebody has to roll, and who could roll it (Phase 28, "The fastest way in").
/// </summary>
...
/// <param name="Engineers">Everybody who can do it, by name.</param>
...
/// <summary>What the Commander's plans need an engineer for (Phase 28).</summary>
public static class PlannedNeeds
{
        ...
        string? named)
    {
        ...
        // The directory's own speciality list, which is how the Colonia four are reachable at all and how a
        // spoken module type — "thrusters" — finds the people who grade it.
