...
public static class GapCapability
{
        ...
        Func<CommanderGameState?>? commander = null) => new()
    {
        ...
        [
            new ToolDefinition
            {
                ...
                Parameters =
                [
                    // A parameter on the tool that already exists, not a second tool
                    // (change-requests.md 37). "What is this shortfall for" is the same question narrowed to
                    // one material, and the narrowed answer is the one with room to name the blueprint -
                    // which the fleet-wide list deliberately does not.
                    new ToolParameter
                    {
                        Name = "material",
        ...
        ToolArguments arguments)
    {
        ...
        // One material asked about is a different answer, not a filtered one (change-requests.md 37).
    ...
    /// <summary>
    /// What one material is for (change-requests.md 37), asked for indirectly on 2026-08-20 when the
    /// Commander asked what a shortfall of Conductive Polymers was for and d47 said:
    /// </summary>
    ...
    /// <summary>
    /// "What is Conductive Polymers for", one phrase per material something actually wants
