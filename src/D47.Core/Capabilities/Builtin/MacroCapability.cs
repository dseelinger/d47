...
/// <summary>Named multi-step sequences the Commander authored (Phase 10, "Macros").</summary>
public static class MacroCapability
{
    ...
    public static CapabilityDescriptor Create(MacroStore store, ActionSurface actions) => new()
    {
        ...
        Tools =
        [
            // Argument-free and first, so "what macros do I have" reaches it through the keyword router with
    ...
    /// <summary>The macro names as router phrases.</summary>
    ...
    /// <summary>A read-only summary that carries the way into the editor.</summary>
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Resolved as a whole before any of it is sent.
