...
public static class VrCapability
{
    ...
    /// <summary>
    /// The one placement row captions have (#204). Spelled like <see cref="LockKey"/>'s answer on
    /// purpose — it is the same choice in the same words — but it is not generated by
    /// <c>Placement</c> and must not be: that helper brings a distance, a curve and a scale with
    /// it, and captions get none of them.
    /// </summary>
