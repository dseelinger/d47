...
/// <summary>Finding exobiology worth landing for (Phase 18, "Find the exobiology").</summary>
public static class ExobiologyCapability
{
    ...
    private static string Body(CommanderGameState? state, ToolArguments arguments)
    {
        ...
        {
            // A real answer, and the one that saves a landing.
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!ExobiologyQuery.TryParse(
                ...
                // The ship's own range where the Commander did not say one, exactly as the other plotters do
                // — a route plotted at a default 50 for a ship that jumps 18 is a route nobody can fly.
