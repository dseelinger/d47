...
public static class PersonaCatalog
{
    ...
    /// <summary>The core with this id, or the default if the id is unknown.</summary>
    public static Persona Resolve(string? id)
    {
        ...
        // The Commander's own, asked second so a shipped id can never be shadowed by one somebody wrote
    ...
    /// <summary>
    /// Whether this id names a core that can be chosen — one d47 ships, or one the Commander wrote.
    /// </summary>
