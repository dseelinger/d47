...
/// <summary>
/// What the Commander wants in one slot of a suit or a hand weapon (Phase 27, "The same page, on
/// foot").
/// </summary>
/// <param name="Slot">
/// <see cref="OnFootBuild.GradeSlot"/>, or <c>Mod 1</c> through <c>Mod 4</c>.
/// </param>
/// <param name="Grade">The grade to reach, on the grade slot.</param>
/// <param name="Modification">What to have an engineer fit, on a mod slot.</param>
...
/// <param name="ItemId">
/// The journal's <c>SuitID</c> or <c>SuitModuleID</c> once the Commander owns it, and null until then.
/// </param>
...
{
    /// <summary>The slot the grade is planned on.</summary>
    ...
    /// <summary>Whether a string names a slot this build can hold.</summary>
