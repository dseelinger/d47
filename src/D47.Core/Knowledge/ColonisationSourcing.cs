...
/// <summary>One station's part in a sourcing plan.</summary>
/// <param name="Market">Where.</param>
/// <param name="Lots">What it covers, and at what price.</param>
/// <param name="Distance">
/// Light years from the reference, or zero where nothing could be measured.
/// </param>
...
/// <param name="Symbol">The folded symbol, which is what it joined on.</param> <param name="Tonnes">How
/// many to buy here — never more than the station has or the site needs.</param> <param
/// name="UnitPrice">Per tonne.</param>
/// </summary>
/// <param name="Commodity">
/// The market's spelling, which is what a Commander reads on the board.
/// </param>
/// <param name="Symbol">The folded symbol, which is what it joined on.</param>
/// <param name="Tonnes">
/// How many to buy here — never more than the station has or the site needs.
/// </param>
...
/// Commodities that were found but not in enough quantity, with how many tonnes are still short after
/// every station in range is counted.
/// </param>
...
public static class ColonisationSourcing
{
    ...
    /// <param name="outstanding">What the site still needs.</param>
    /// <param name="markets">
    /// Everything in range, already aged out by whoever knew the time.
    /// </param>
    ...
    /// <param name="maxStops">
    /// A ceiling on stations, so an answer stays one a Commander can act on.
    /// </param>
        ...
        int maxStops = 6)
    {
        ...
        foreach (var resource in outstanding)
        {
            ...
            // The symbol is the identity and the name is the spelling, and the two are never interchanged.
        ...
        // What is left over is two different failures and they are reported as two.
    ...
    /// <summary>The station that clears most of what is left.</summary>
    ...
    /// <summary>A market's quote for one outstanding row.</summary>
