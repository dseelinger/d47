...
/// <summary>
/// The structured summary of what happened, and the only thing the generator is ever handed (Phase 33,
...
public sealed record LogDigest
{
    ...
    /// <summary>Facts computed and then dropped to stay under the cap.</summary>
    public int FactsDropped { get; init; }

    public bool Any => Facts.Count > 0;

    /// <summary>The text handed to the model.</summary>
