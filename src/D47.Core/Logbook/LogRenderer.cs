...
/// <summary>Everything one finished log knows about itself.</summary>
public sealed record LogWritten
{
    ...
    /// <summary>What it actually cost, from the provider.</summary>
...
/// <summary>
/// The markdown file (Phase 33, item 1: "written to <c>data/</c> in plain markdown so it can be kept,
/// edited and posted somewhere").
/// </summary>
public static class LogRenderer
{
    ...
    /// <summary>What the log drew on.</summary>
    ...
    /// <summary>A cell that cannot break the table it is in.</summary>
