...
public enum ProposalKind
{
    ...
    /// <summary>Un-tick one.</summary>
    Reopen,

    /// <summary>Take one off the list.</summary>
    Remove,
...
/// <summary>Something d47 would like to do to the Commander's checklist, waiting for them to agree.</summary>
public sealed record ChecklistProposal
{
    ...
    /// <summary>The lines to add, or the plan's whole item set.</summary>
...
public sealed class ChecklistProposalStore(string path, ILogger<ChecklistProposalStore> logger)
{
    ...
    /// <summary>Records a proposal.</summary>
    ...
    /// <summary>Takes the proposals for one Commander off the file, leaving anybody else's alone.</summary>
    ...
    /// <summary>Whether two proposals are the same request.</summary>
    ...
    /// <summary>
    /// A proposal is checked exactly as hard as the list it wants to change — every item it carries
    /// goes through <see cref="ChecklistValidation"/>.
    /// </summary>
