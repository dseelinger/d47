...
/// <summary>What an erasure request left behind (#167).</summary>
/// <param name="Asked">Whether the store was asked at all.</param>
/// <param name="Answered">Whether the store said it had done it.</param>
/// <param name="Deleted">How many objects went.</param>
/// <param name="More">Whether the store said there is more behind what it deleted.</param>
...
/// <summary>
/// The donor's own copy of a withdrawal, written on this machine at the moment of asking (#167).
/// </summary>
