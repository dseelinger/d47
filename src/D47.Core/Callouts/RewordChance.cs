...
public sealed class RewordChance(Random? choice = null)
{
    ...
    /// <summary>
    /// True if this announcement should be reworded. An ambient remark always is; every other line is
    /// decided independently against <paramref name="rewordPercent"/> (0-100, clamped).
    /// </summary>
