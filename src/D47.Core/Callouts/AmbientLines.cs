...
/// <summary>The situations d47 will remark on unprompted.</summary>
public enum AmbientSituation
{
    ...
    /// <summary>Taking on fuel from a star.</summary>
    Scooping,
...
/// <summary>The stock ambient lines (Phase 11, "Ambient Voice").</summary>
public static class AmbientLines
{
    /// <summary>Which situation the Commander is in, from Status.json alone.</summary>
    public static AmbientSituation Situate(GameStatus status)
    {
        ...
        // Before Supercruise, because scooping happens in supercruise and is the more specific thing to be
        // doing.
    ...
    /// <summary>One of them, chosen by an index the caller supplies.</summary>
    ...
    [
        ...
        // Not "mass lock is clear", which was the reported one: that is a transition, true for seconds and
        // nonsense an hour later.
        ...
        // Reported 2026-08-21 from the normal-space pool, where it had lived since Phase 11: heard at
        // thruster speeds it reads as a remark about going slowly, and the Commander's ruling is that it
        // belongs to the speeds a human could *not* have understood — supercruise and the jump, which
        // Status.json reports under the same flag.
