...
/// <param name="WidthMetres">Settable.</param>
...
/// <param name="V">Down, from the top edge — raster order, not OpenVR's Y-up.</param>
...
/// <summary>Where a controller's ray meets a panel, worked out here rather than asked of the runtime.</summary>
public static class VrRay
{
    /// <summary>Below this a panel is treated as flat.</summary>
    private const float Flat = 1e-3f;

    /// <summary>OpenVR does not document what <c>fCurvature</c> actually draws and no call will say.</summary>
    ...
    /// <summary>Where a ray in the tracking universe meets the panel, or null.</summary>
    ...
    /// <summary>Which hand is pointing at the panel and where its ray lands, nearest hit winning.</summary>
