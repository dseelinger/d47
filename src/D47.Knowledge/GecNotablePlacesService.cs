...
/// <summary>
/// <see cref="INotablePlacesService"/> against EDAstro's Galactic Exploration Catalog — the community
/// catalogue the Galactic Mapping Project was migrated into (Phase 47).
/// </summary>
public sealed class GecNotablePlacesService : INotablePlacesService, IDisposable
{
    /// <summary>
    /// Named here and in <see cref="D47.Core.Configuration.EgressDisclosure"/>, like the spansh host.
    /// </summary>
    ...
    /// bracketed list inside one, ids as decimal text.
    /// </summary>
