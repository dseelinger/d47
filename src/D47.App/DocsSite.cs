...
public static class DocsSite
{
    ...
    /// <para>
    /// <b>The general pages were being addressed as capabilities</b>, so the "Read the full page"
    /// card at the foot of Overview, Installing and Talking to Directive 47 pointed at
