...
/// <summary>A small spinning arc, for the moment between asking d47 for something and getting it.</summary>
public sealed class BusyGlyph : Control
{
    /// <summary>The arc's colour.</summary>
    public static readonly StyledProperty<IBrush?> StrokeProperty =
        AvaloniaProperty.Register<BusyGlyph, IBrush?>(nameof(Stroke));

    /// <summary>How much of the ring is drawn, in degrees.</summary>
    private const double SweepDegrees = 270;

    /// <summary>Where the arc starts, in degrees.</summary>
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        var spin = new Animation
        {
            ...
            // Linear, because a spinner that eases is a spinner that looks like it is struggling rather than
            // working.
