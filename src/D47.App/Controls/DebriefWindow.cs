...
public sealed class DebriefWindow : Window
{
    ...
    private void Refresh()
    {
        ...
        // The Commander's own words are in this file, so a line that could not be read back is reported
    ...
    /// <summary>The block as the prompt will carry it, general directions and this core's overlay both.</summary>
    ...
    private Control Proposal(StandingDirection entry)
    {
        ...
        {
            // Where the recorder was running.
