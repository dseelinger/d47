...
`EngineeringInfo`'s own reputation field is read and discarded: it states the mechanic, not a fact
about the engineer, and the mechanic is the same for every one of them.
...
COLUMNS = [
    ...
    "referred_by", "referral_grade", "body", "discovery", "meeting", "unlock",
...
def chain() -> dict[str, dict]:
    ...
    for name, _system, _base, x, y, z, body, discovery, meeting, unlock, _rep, _odyssey in found:
        referrers, grade = [], ""
...
def main() -> None:
    ...
    lines = [
        ...
        "# blueprints.json (MIT). The referral chain, body and unlock prose come",
