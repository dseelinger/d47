...
;
; Per-user and unelevated, by design rather than by preference. Two properties are never traded
; away — no elevation and no runtime prerequisite. So this installs to
