...
| `ElevenLabsModelProbe` | Is `eleven_v3_conversational` a model d47 could offer beside the pinned Flash 2.5 - does it hold `language_code`, does its speed control do anything, and what does a line cost in wall-clock? | [docs/spikes/elevenlabs-v3-conversational.md](../docs/spikes/elevenlabs-v3-conversational.md) |
