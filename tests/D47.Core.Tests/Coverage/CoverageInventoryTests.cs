...
/// <summary>
/// The inventory is derived from the registry rather than maintained beside it, so a capability added
/// in a later phase shows up as never-exercised the day it is written and nobody has to remember to
/// list it.
/// </summary>
public class CoverageInventoryTests
{
    ...
    /// <summary>The capability id is identity, not definition.</summary>
    [Fact]
    ...
    /// <summary>
    /// A row whose wording changed is a row worth looking at again, because the wording is most of what
    /// a Commander judges it by.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Eleven of d47's tools take no arguments, and the canonical schema writer emits only parameters —
