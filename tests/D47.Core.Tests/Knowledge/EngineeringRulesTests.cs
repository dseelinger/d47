...
/// <summary>The fixed game rules, checked against the numbers a 912-journal corpus actually measured.</summary>
public class EngineeringRulesTests
{
    ...
    {
        // Every dash in the published table.
    ...
    {
        // The corpus's strongest single result: 1,428 of 1,428 grade 5 deltas are 0.2, which is what "grade N
        // is unreachable below rank N" predicts and what nothing else does.
    ...
    {
        // Observed deltas are 0.333 and 0.334, never 0.34.
    ...
    {
        // The bug that would have shipped. 93% of grades reach exactly 1.0, so gating on that would have
        // looked correct in testing and told the other 7% their finished module was not.
    ...
    [Theory]
    // The corpus's own ratio table, paid: received, over 1,096 trades.
    ...
    {
        // Within a line a grade names exactly one material, so a same-grade same-line exchange is a material
        // for itself.
    ...
    {
        // Arithmetic the rules permit and the caps do not.
 ...
 /// What d47 says about getting a rank up is true, and it is Frontier's table saying it.
    ...
    {
        // The claim in one sentence, checked against the table it is a claim about: for any grade, the
        // further the rank is above it, the fewer rolls that grade takes.
