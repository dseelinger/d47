...
/// <summary>
/// Reading a system name back to the Commander — including the two
/// refusals that are the point of the item: no payout claim, and no star class for a system d47 never
/// watched them arrive at.
/// </summary>
public class SystemNameCapabilityTests
{
    ...
    public async Task ANameReadAloudBorrowsNoStarFromWhereTheCommanderIsStanding()
    {
        ...
        // And it is still there for the system they are in, so the guard is about the name rather than about
        // having lost the class.
    ...
    /// <summary>
    /// No journal and no name is not an error — it is a prompt, because this is the one capability that
    /// can answer without ever having seen the system.
    /// </summary>
    [Fact]
