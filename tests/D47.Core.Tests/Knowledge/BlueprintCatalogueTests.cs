...
/// <summary>The generated blueprint table, against the real embedded resource.</summary>
public class BlueprintCatalogueTests
{
    ...
    {
        // A blueprint asking for something no id list names cannot be totalled, and a short total is worse
        // than none.
    ...
    {
        // The rule that makes "ingredients x rolls" exact. 57 graded rows break it and every one is synthesis
        // — munitions, refills, limpets, SRV repair — which is why kind exists.
    ...
    {
        // Multiplying a synthesis recipe or an engineer's tribute by a roll count is arithmetic on the wrong
        // kind of thing, so it answers null rather than a plausible number.
    ...
    {
        // The reason coriolis cannot be the authority here.
    ...
    {
        // "Lightweight" is a dozen different recipes.
    ...
    public void ABlueprintSaysWhatItDoesAndWhoOffersIt()
    {
        ...
        // Long range costs power draw, integrity and mass.
    ...
    {
        // Gold x200 in a tribute is two hundred tonnes of cargo, and the ingredient can say so without the
        // caller having to look it up separately.
    ...
    {
        // EDEngineer's Effects were recorded as double-encoded, arriving as "âœ“".
