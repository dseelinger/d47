...
/// <summary>The generated material table, and the four things it carries that the journal does not.</summary>
public class MaterialCatalogueTests
{
    ...
    {
        // Lei Cheung wants Gold ×200, which is two hundred tonnes.
    ...
    {
        // Two generated tables from the same source file.
    ...
    {
        // The trap the line column exists for.
    ...
    {
        // They are grouped for display and the trader does not deal in them.
    ...
    {
        // Keying on EDEngineer's own id loses 22 of the 45 Encoded materials, silently, because it keeps the
        // leading adjective Frontier drops.
    ...
    {
        // Each is a display name one source spells differently.
    ...
    {
        // The near-miss that must not be aliased.
    ...
    {
        // "Wreckage Components" is a Thargoid material and a salvage commodity.
