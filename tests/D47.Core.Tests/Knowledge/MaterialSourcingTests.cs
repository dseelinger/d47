...
public class MaterialSourcingTests
{
    private sealed class FakeGalaxy : IGalaxyService
    {
        ...
        /// <summary>Not what this file is about.</summary>
    ...
    public async Task AMaterialTheIndexDoesNotCarryIsDeclinedByNameRatherThanSearchedFor()
    {
        ...
        // Three of the 28 raw materials are missing from the index.
    ...
    public async Task AStateGatedMaterialBecomesASystemSearchWordedAsAReport()
    {
        ...
        // Imperial Shielding's origin names both a superpower and nothing else; Proto Radiolic Alloys names a
        // state.
        ...
        // Crowd-reported and it turns over on the background simulation's tick, so the wording is "reported
        // in", the same framing the station stock carries.
    ...
    public async Task ATradeOutOfWhatIsAboardIsOfferedAndPricedInLowestTerms()
    {
        ...
        // Iron is grade 1 and Vanadium grade 2, and they are in different lines — so the exchange is the
        // published rate reduced, and 300 Iron is worth a real number of Vanadium.
    ...
    /// <summary>The offer says whose offer it is.</summary>
    [Fact]
    ...
    public async Task TheTraderSearchAsksTheIndexForTheTypeRatherThanGuessingFromEconomies()
    {
        ...
        // The index carries material_trader outright, which retires the economy heuristic that classified 152
        // of 200 real traders as Raw.
    ...
    public async Task ATraderTheIndexCannotClassifyIsSaidToBeUnrecordedRatherThanGuessedAt()
    {
        ...
        // One station in fifty carries the service and no type.
    ...
    public async Task WithNoGalaxyServiceAMaterialStillAnswersFromTheShippedTable()
    {
        ...
        // Capabilities are state, not guards: where it is found is a shipped fact and does not need the
        // network.
        var answer = await Ask(registry, "find_material", ("material", "Yttrium"));
