...
public class MarketBookTests
{
    ...
    public void TheCommandersOwnBoardIsReadWithItsPricesAndItsPosition()
    {
        ...
        // Elite calls supply "Stock" in this file and the index calls it "supply".
        Assert.Equal(1_200, market.Quote("Painite")?.Demand);

        // No _Localised on the second row, so the symbol is folded and cased rather than spoken as
        // "$painite_name;".
