...
public class ExobiologyCapabilityTests
{
    ...
    /// <summary>The ceiling that shapes this half.</summary>
    [Fact]
    ...
    /// <summary>A ring signal Elite did not localise is said the way the rest of the list is said.</summary>
    [Fact]
    ...
    /// <summary>
    /// A scan that found nothing is a real answer and the one that saves a landing — different from d47
    /// never having looked.
    /// </summary>
    [Fact]
 ...
 /// four bodies in five.
    ...
    /// <summary>
    /// Order matters: a surface scan is the later, fuller answer and always replaces an FSS row for the
    /// same body.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The other direction must never happen: an FSS row arriving after a surface scan must not erase
    /// the genera the surface scan already found.
    /// </summary>
    [Fact]
 ...
 /// <summary>Capabilities are state rather than guards.</summary>
    [Fact]
