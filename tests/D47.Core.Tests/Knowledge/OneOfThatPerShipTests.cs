...
/// <summary>The groups Frontier allows only so many of per ship.</summary>
public class OneOfThatPerShipTests
{
    ...
    {
        // The case a per-module check would miss: they are different modules with different names, and
        // fitting either means you may not fit the other.
