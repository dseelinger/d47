...
/// <summary>Where to buy it, and what it costs there.</summary>
public class WhereToBuyItTests
{
    ...
    /// <summary>The checklist's own example, both ways.</summary>
    [Theory]
    [InlineData(8, "Near")]
    [InlineData(780, "Far")]
    ...
    /// <summary>
    /// Without a tonnage there is nothing to weigh a detour against, so price decides and the distance
    /// is reported rather than priced.
    /// </summary>
    [Fact]
    ...
    /// <summary>Supply is a filter and not a footnote.</summary>
    [Fact]
    ...
    public void SellingRanksTheHighestPayerFirstAndNeedsDemandRatherThanSupply()
    {
        var offers = CommodityMarketSearch.Rank(
            ...
            [
                ...
                // Sells it cheaply, buys none of it.
    ...
    /// <summary>
    /// A carrier's prices are player-set and can be a joke, and the station itself may be a hundred
    /// light years away by the time the Commander arrives.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// A station that neither sells nor stocks it is not an answer, and a zero price is not a bargain.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The commodity is the join key between a market and everything else, and it is folded rather than
    /// re-spelled. "low temperature diamonds" has to find "Low Temperature Diamonds".
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// With no origin nothing can be measured, so the radius cannot be applied and price alone decides.
    /// </summary>
    [Fact]
