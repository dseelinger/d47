...
public class GalaxyQueryTests
{
    ...
    {
        // Measured against the live service: 'allegience' returned the same 108 systems as no filter at all,
        // while 'allegiance' returned 60.
    ...
    {
        // A tool error saying only "invalid filter" invites the model to guess again out of the same
        // vocabulary it just invented.
    ...
    {
        // Forgiving on the way in because the model is speaking; exact on the way out because the service is
        // not.
    ...
    {
        // "Systems within 20 light years" is the question people ask. "Systems exactly 20 light years away"
        // is not.
    ...
    {
        // A model asking for fifty is not making an error worth an error message; it is asking for more than
        // can be read aloud in a cockpit.
