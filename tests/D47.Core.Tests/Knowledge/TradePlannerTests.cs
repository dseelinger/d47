...
/// <summary>d47's own trade arithmetic.</summary>
public class TradePlannerTests
{
    ...
    {
        // The twist, and the one thing no other planner does.
        var markets = new[]
        {
    ...
    {
        // The whole of d47's saturation answer, and deliberately the conservative half of it.
        var markets = new[]
        {
            Market("Origin", 0, ("Gold", 1_000, 0, 1_000, 0)),
    ...
    {
        // Measured 2026-08-19: the best Gold price within 50 light years of Sol was 4,760,900 credits at a
        // carrier, against 52,282 at the best station.
    ...
    {
        // Priced per station, capped at a handful of tonnes by the game itself, and worth less the closer
        // they are sold to home.
    ...
    {
        // Null is "I cannot see the board you are standing in front of".
    ...
    {
        // The Commander is already docked there.
        var markets = new[]
        {
    ...
    {
        // The anchor is what the borrowed planner cost: Spansh answered a four-hop trade route in forty-eight
        // seconds, measured 2026-08-14.
        ...
        // Generous by a wide margin against the tens of milliseconds this measures at, because a build agent
        // under load is not a workstation.
        Assert.True(
