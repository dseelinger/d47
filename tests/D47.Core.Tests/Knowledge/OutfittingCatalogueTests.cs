...
/// <summary>Matching what a Commander said against the real catalogue.</summary>
public class OutfittingCatalogueTests
{
    ...
    {
        // A Commander who said a real thing shortly should not be shown a list headed by a typo of something
        // else.
    ...
    {
        // Read from the service's own field_values endpoints on 2026-08-14.
