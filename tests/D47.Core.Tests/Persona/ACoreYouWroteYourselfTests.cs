...
public class ACoreYouWroteYourselfTests : IDisposable
{
    ...
    /// <summary>The frame is supplied and only the character is the Commander's.</summary>
    [Fact]
    ...
    /// <summary>
    /// The id does not follow the name, so correcting a typo does not leave the Commander talking to
    /// Warden again.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The voice description reaches the pairing, which is the whole reason it is a field rather than a
    /// picker: a provider's catalogue is its own and a description outlives it.
    /// </summary>
    [Fact]
    ...
    /// <summary>The picker still offers a drop-down rather than a search window.</summary>
    [Fact]
