...
/// <summary>No two shipped cores answer in the same voice.</summary>
public class NoTwoCoresShareAVoiceTests
{
    ...
    [
        ...
        // Unlabelled, which every core's description admits.
    ...
    /// <summary>The model handing the same voice to two cores.</summary>
    [Fact]
    ...
    public async Task AVoiceAlreadyInUseIsNotGivenAway()
    {
        ...
        // Paired with something else rather than left with nothing: a core with no pairing speaks in the
        // provider's default, and two of those are two cores in one voice.
