...
/// <summary>What every arc is worth right now.</summary>
public class GoalEvaluatorTests
{
    ...
    public void LiveStateIsPreferredToTheMine()
    {
        ...
        // The start still comes from the mine, because live state cannot know it.
    ...
    /// <summary>Item 2's whole sentence, as one assertion.</summary>
    [Fact]
    ...
    /// <summary>
    /// The fleet snapshot is taken at a shipyard and does not list the hull the Commander arrived in,
    /// so counting only the snapshot loses one hull for as long as they are sitting in it.
    /// </summary>
    [Fact]
