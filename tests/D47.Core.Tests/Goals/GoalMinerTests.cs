...
public class GoalMinerTests : IDisposable
{
    ...
    /// <summary>A rank that goes down is a save started again, and the corpus proved it.</summary>
    [Fact]
    ...
    /// <summary>
    /// The same rule for the engineers, which is where a maximum would have been most misleading: the
    /// account above would have been told it had twenty-three unlocked when the current save has four.
    /// </summary>
    [Fact]
    ...
    /// <summary>The snapshot counts and the delta does not.</summary>
    [Fact]
    ...
    /// <summary>
    /// Three accounts in one folder is what a long corpus really looks like, and pooling them would
    /// report one person's progress to another.
    /// </summary>
    [Fact]
