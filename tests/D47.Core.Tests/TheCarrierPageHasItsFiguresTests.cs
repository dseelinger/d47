...
/// <summary>
/// The figures a carrier page needs, folded into the state that already discriminates the Commander's
/// carrier from a squadron's.
/// </summary>
public class TheCarrierPageHasItsFiguresTests
{
    ...
    /// <summary>
    /// Bought and switched on are different states, and only one of them is something a Commander can
    /// dock and use.
    /// </summary>
    [Fact]
    ...
    /// <summary>A stats event with no Crew array says nothing about the services.</summary>
    [Fact]
    ...
    /// <summary>The destination body rides with the system, and both ways out of a jump clear it.</summary>
    [Theory]
