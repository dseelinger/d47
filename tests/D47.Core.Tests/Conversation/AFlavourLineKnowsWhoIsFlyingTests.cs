...
/// <summary>The Commander's own account of themselves reaches the lines said in character.</summary>
public class AFlavourLineKnowsWhoIsFlyingTests
{
    ...
    public async Task TheStoryIsPositionFourOfTheFlavourPrompt()
    {
        ...
        // In the cached block, after the persona and under the committing label — the same place and the same
        // words a turn puts it, so the ship's AI is the same AI in both.
