...
/// <summary>
/// The volatility ordering is the whole reason prompt caching works, and the guardrails sitting above
/// the persona is the whole reason "Personality on/off" is safe.
/// </summary>
public class PromptAssemblyTests
{
    ...
    {
        // Not a behavioural assertion so much as a structural one: if this ever compiles with an instance
        // setter, the property has stopped being unremovable.
 ...
 /// <summary>Position 4 is labelled to commit, not to hedge.</summary>
    [Fact]
    public void AboutMeIsPresentedAsTrueOfTheWorldTheyShare()
    {
        ...
        // The old label, which said only whose words they were and nothing about what to do with them.
