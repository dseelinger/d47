...
public class SwitchMappingTests
{
    ...
    {
        // The rule that keeps a switch from being a press.
    ...
    {
        // "boost" is real, bindable, and reports nothing.
 ...
 /// <summary>A position may name a page of d47's own panel instead of an action.</summary>
    [Fact]
