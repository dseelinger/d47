...
/// <summary>What the Commander is wearing.</summary>
public class OnFootLoadoutTests
{
    ...
    /// <summary>The trap that would have shipped.</summary>
    [Fact]
    ...
    /// <summary>
    /// Five of the thirteen observed symbols join their recipe name on a relaxed match and eight do
    /// not.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <c>UpgradeSuit</c> carries the suit's old symbol beside its new class, so reading the grade off
    /// the symbol on that one event is off by one.
    /// </summary>
    [Fact]
    ...
    /// <summary>The free suit has no class suffix at all, cannot be upgraded and cannot be modified.</summary>
    [Fact]
    ...
    /// <summary>
    /// Elite spells the same suit two ways — <c>SuitLoadout</c> lower case, <c>BuySuit</c> mixed — so
    /// the table lookup folds.
    /// </summary>
    [Fact]
    ...
    /// <summary>A snapshot, not a merge.</summary>
    [Fact]
 ...
 /// <summary>A weapon sold out of the loadout being carried leaves its slot.</summary>
    [Fact]
