...
public class GameStateStoreTests
{
 ...
 /// <summary>One switch signal.</summary>
    [Fact]
    ...
    /// <summary>
    /// Raised with the new Commander already active, so a subscriber can read who is flying from the
    /// store rather than only from the signal.
    /// </summary>
    [Fact]
