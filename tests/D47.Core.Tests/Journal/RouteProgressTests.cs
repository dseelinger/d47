...
/// <summary>Where the Commander is in a plotted route.</summary>
public class RouteProgressTests
{
    ...
    {
        // The route file is not rewritten as the Commander advances, so "how far is left" is a question about
    ...
    public void JumpingOffTheRouteLeavesAllOfItAhead()
    {
        ...
        // Every hop, because none has been reached — the same reading NavRoute.Ahead takes, and it beats
        // claiming the route is complete.
    ...
    {
        // A leg of unknown length makes the total unknown.
        var progress = RouteProgress.For(
    ...
    {
        // Before the journal has said where the Commander is, assuming they are at hop zero would report a
        // route already begun.
