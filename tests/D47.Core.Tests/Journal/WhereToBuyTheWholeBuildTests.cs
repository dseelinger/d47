...
public class WhereToBuyTheWholeBuildTests
{
    ...
    /// <summary>
    /// The unit is this station covers six of your twenty, because that is the sentence a Commander
    /// acts on.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Posted on the way out, so the Checklist tab draws the answer the Commander was just given rather
    /// than running a second search that could disagree with it.
    /// </summary>
    [Fact]
