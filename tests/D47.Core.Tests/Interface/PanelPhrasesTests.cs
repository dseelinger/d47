...
/// <summary>Moving the panel by saying so.</summary>
public class PanelPhrasesTests
{
    ...
    // The destination said last from the headset. "Set tab to checklist" matched nothing because every
    // combination named the destination in the middle, and "set" was not an opener either — two independent
    // reasons for one miss.
    ...
    // The openers added 2026-08-23 widened the grammar and must not have widened it past whole phrases.
    ...
    /// <summary>
    /// Each crumb is a word that can be said as well as pressed, which is what makes the breadcrumb the
    /// same affordance in both modalities rather than two vocabularies.
    /// </summary>
    [Fact]
