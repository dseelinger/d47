...
/// <summary>The arithmetic behind "Search whichever tab you are looking at".</summary>
public class TextSearchTests
{
    ...
    /// <summary>Non-overlapping, resuming past the end of each hit.</summary>
    [Fact]
    ...
    /// <summary>
    /// The current hit is held as an offset, so a line arriving at the end of the log leaves it naming
    ...
    /// <summary>
    /// A hit that is no longer there hands back the nearest one after it, rather than sending the
    /// reader back to the top of a page they had scrolled through.
    /// </summary>
    [Fact]
