...
/// <summary>Switching provider and switching back costs nothing.</summary>
public class VoicesAreRememberedPerProviderTests
{
    ...
    /// <summary>The field the item is really about.</summary>
    [Fact]
    ...
    /// <summary>The stash holds the providers not in use and nothing else.</summary>
    [Fact]
    ...
    /// <summary>A settings file written before d47 recorded whose voices these are.</summary>
    [Fact]
    public void VoicesWithNoRecordedOwnerAreDroppedRatherThanFiledUnderAGuess()
    {
        ...
        // Stamped, not cleared — see VoiceMemory.Reconciled.
    ...
    /// <summary>
    /// Provider ids are compared case-insensitively everywhere else, and a hand-edited file spelling
    /// one "Edge" must find the same entry rather than a second one.
    /// </summary>
    [Fact]
