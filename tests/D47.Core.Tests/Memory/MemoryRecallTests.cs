...
/// <summary>What reaches a prompt, and what it costs to put it there.</summary>
public class MemoryRecallTests
{
    ...
    {
        // Four facts at the store's own ceiling would be 1,600 characters, over the budget, so the character
        // bound has to bind before the count one does.
    ...
    /// <summary>The property the placement above the breakpoint rests on.</summary>
    [Fact]
    public void FlyingSomewhereWithNoHistoryRendersTheSameBytes()
    {
        ...
        // And no situation leaks into the text, which is what makes the equality above structural rather than
        // a coincidence of these three names.
    ...
    public void RecallSitsInsideTheCachedBlockBelowAboutMeAndBelowTheGuardrails()
    {
        ...
        // Order is the type's contract: guardrails can never be pushed down by anything, and recall is d47's
        // account of the Commander so it reads after their own.
    ...
    public void NoRecallLeavesTheCachedBlockExactlyAsItWasBeforeThePhase()
    {
        ...
        // A Commander who has never had anything written down must pay nothing for the section existing —
        // including not paying a blank line for it.
