...
public class MemoryCapabilityTests
{
    ...
    /// fills up when somebody opens a panel, and the moment a Commander says something worth keeping is
    /// a moment they are talking rather than clicking.
    /// </summary>
    [Fact]
    ...
    /// <summary>And the other two are not — which is what keeps the profile under the ceiling.</summary>
    [Fact]
    ...
    /// <summary>The write tool takes a sentence and nothing else.</summary>
    [Fact]
    ...
    /// <summary>
    /// The store is a real thing on a machine and a null on the designer, and every tool has to answer
    /// for the second case rather than throwing into a panel that is trying to render.
    /// </summary>
    [Fact]
