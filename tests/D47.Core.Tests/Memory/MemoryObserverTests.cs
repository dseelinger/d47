...
public class MemoryObserverTests : IDisposable
{
    ...
    /// <summary>The property that keeps the file readable.</summary>
    [Fact]
    ...
    {
        // The panel uses this to decide whether to offer a Forget button: an observation is rewritten the
        // moment the Commander moves, so removing one looks broken rather than decisive.
