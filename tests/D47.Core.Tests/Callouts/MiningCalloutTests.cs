...
/// <summary>Prospector and core callouts.</summary>
public class MiningCalloutTests
{
    ...
    /// <summary>The measured trap.</summary>
    [Fact]
    ...
    /// <summary>A session best needs something to have beaten.</summary>
    [Fact]
    ...
    /// <summary>The identity fold.</summary>
    [Fact]
    ...
    /// <summary>
    /// The backlog is folded and not spoken — otherwise starting d47 after an hour of mining reads out
    /// an hour of rocks.
    /// </summary>
    [Fact]
    ...
    /// <summary>Exciting is not dangerous.</summary>
    [Fact]
