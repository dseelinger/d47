...
/// <summary>
/// One invented person gets one voice, however the model spells their name between lines of the same
/// exchange.
/// </summary>
public class OnePersonInAnExchangeHasOneVoiceTests
{
    ...
    public void TwoPeopleWhoShareASurnameStayTwoPeople()
    {
        ...
        // The bare surname could be either of them, and a wrong fold is the reported fault pointed the other
        // way — so it stays as written.
    ...
    public void TheCarriersOwnPostsTakeNoPartInTheFolding()
    {
        ...
        // "Captain Reyes" is a pilot with a rank, not a second spelling of the captain: the post keeps its
        // role and its name, and the pilot keeps hers.
