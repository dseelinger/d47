...
/// <summary>
/// "A sentence that cannot be traced back is the bug this item exists to prevent".
/// </summary>
public class LogAuditTests
{
    ...
    /// <summary>
    /// Worse than citing nothing, because it looks like evidence: a reader glancing at the brackets
    /// sees a sourced claim.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Elite reports a great many decimals — 8.09 ly, 0.24 g — and a splitter that treated each as a
    /// full stop would report half a log as uncited fragments and mark a clean file as broken.
    /// </summary>
    [Fact]
    ...
    /// <summary>Headings are structure.</summary>
    [Fact]
