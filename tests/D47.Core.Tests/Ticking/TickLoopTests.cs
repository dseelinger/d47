...
/// <summary>The loop, driven by hand.</summary>
public class TickLoopTests
{
    ...
    public void TheFirstTickIsMarkedAsSuch()
    {
        ...
        // This is how the startup priming tick is told apart from a live one, which is what keeps a journal
        // backlog from being announced as though it had just happened.
    ...
    public void TimeComesFromTheCallerNotTheClock()
    {
        ...
        // A journal fixture's timestamps, replayed.
        var fixture = new[]
        {
