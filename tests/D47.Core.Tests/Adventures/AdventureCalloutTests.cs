...
public class AdventureCalloutTests : IDisposable
{
    ...
    public void ABeatWaitsOutTheSettleAndThenSpeaksTheAuthoredLine()
    {
        ...
        // The acknowledgement lands on the tick the beat fired, with no settle behind it — that is the whole
 // of what it is for.
        ...
        // The line, then where to go next — and for a scan, how, because "scan X" sends a Commander looking
        // for a surface scanner they do not need.
        Assert.Equal(
