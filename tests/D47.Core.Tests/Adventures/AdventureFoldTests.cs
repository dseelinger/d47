...
/// <summary>Progress is derived, and an adventure counts forward only.</summary>
public class AdventureFoldTests
{
    ...
    {
        // The Commander flew the whole route last week.
    ...
    /// <summary>
    /// #77: a story stuck on a body the Commander had already scanned, because Elite writes <c>Scan</c>
    /// once and then, overwhelmingly, never again.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// #77 as the tester met it: the destination is a body scanned long ago, so no <c>Scan</c> is ever
    /// written again and the beat waits forever.
    /// </summary>
    [Fact]
