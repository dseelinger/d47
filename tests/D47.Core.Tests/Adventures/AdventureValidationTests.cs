...
/// <summary>The trigger vocabulary is closed and the prose is free.</summary>
public class AdventureValidationTests
{
    ...
    /// <summary>Elite scans a body on the approach, before any landing, so a scan beat after a landing on that body is spent before it is current and the story can never finish.</summary>
    [Fact]
