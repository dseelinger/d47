...
/// <summary>
/// Markdown out of what is heard (2026-08-31: a voice read "asterisk asterisk" through a whole docking
/// report).
/// </summary>
public class PlainSpeechTests
{
    ...
    /// <summary>
    /// An emphasis split across the sentence splitter leaves one unmatched pair of asterisks in each
    /// half; a voice reading "asterisk asterisk" at the seam is the reported defect.
    /// </summary>
    [Fact]
