...
/// <summary>Per-category level, mute and ducking.</summary>
public class AudioMixTests
{
    ...
    public void HowFarACategoryDucksFollowsItsOwnSetting()
    {
        ...
        // The duck is a fraction of the level rather than a level of its own: turn the category down and its
        // ducked form goes down with it.
    ...
    /// <summary>A level moved while something is audible takes effect on the thing that is audible.</summary>
    [Fact]
    ...
    /// <summary>
    /// Every channel has a level and a mute, generated from the enum — so a category added later cannot
    /// ship without them, which would present as "d47 is too loud and there is no setting for it".
    /// </summary>
    [Fact]
