...
/// <summary> Which voices a re-voiced sender can be drawn from. </summary>
public class VoicePoolTests
{
    /// <summary>
    /// Edge's tags are real locales, and filtering them is the reason this filter exists: a wingmate
    /// drawn from every language Edge supports is a wingmate most Commanders cannot understand.
    /// </summary>
    [Theory]
    ...
    /// <summary>
    /// ElevenLabs puts an accent in the same field, because its model is multilingual and a voice does
    /// not belong to a locale.
    /// </summary>
    [Theory]
    [InlineData("american")]
    [InlineData("british")]
    ...
    /// <summary>
    /// The whole account, end to end, in the shape the provider reports it: an accent label per voice.
    /// </summary>
    [Fact]
