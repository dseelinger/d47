...
/// <summary>What was said, beside who said it.</summary>
public class TheLogSaysWhatWasSaidTests
{
    ...
    /// <summary>
    /// One line per utterance rather than per sentence, and it carries the whole of what went out.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// A caller with no name of its own reads as d47, matching the voice line beside it rather than
    /// inventing a second convention for the same absence.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The delivery direction stays in this line and in no other (#291, asked for on 2026-09-04 after
    /// reading it as a line of its own and preferring it in place).
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// And a provider that would read the brackets aloud has none to write down, because none was sent
    /// — the log says what went out, so for Flash and the local voice it says the words alone.
    /// </summary>
    [Fact]
