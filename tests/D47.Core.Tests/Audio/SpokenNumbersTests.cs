...
/// <summary> Numerals written out for a voice. </summary>
public class SpokenNumbersTests
{
    ...
    /// <summary>
    /// A full stop that ends a sentence is not a decimal point, and the difference is whether a digit
    /// follows it. "100.
    /// </summary>
    [Fact]
    ...
    /// <summary>Digits touching a letter are part of an identifier.</summary>
    [Theory]
    ...
    /// <summary>A figure past the ceiling is left as digits rather than read as a sentence of its own.</summary>
    [Fact]
