...
/// <summary>
/// Tool definitions serialize first in an LLM request and caching is a prefix match, so a single
/// changed byte here invalidates the whole cached prefix rather than a tail of it.
/// </summary>
public class ToolSchemaDeterminismTests
{
    ...
    public void SchemaShapeIsWhatAProviderExpects()
    {
        ...
        // Compact and fully specified: no indentation to keep stable, and additionalProperties closed so an
        // invented argument is a schema violation rather than a silent pass.
        Assert.Equal(
