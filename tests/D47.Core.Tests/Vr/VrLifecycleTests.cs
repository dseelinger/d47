...
/// <summary>Order agnostic Overlay, driven with no headset in the room.</summary>
public class VrLifecycleTests
{
    ...
    public void SteamVrStartingAfterD47IsJustTheNextAttempt()
    {
        ...
        // Two minutes of a Commander finding their headset.
    ...
    public void AttemptsAreSpacedByTheRetryIntervalRatherThanMadeEveryTick()
    {
        ...
        // 10 Hz, which is the tick loop's real rate.
    ...
    public void SteamVrExitingUnderD47DropsBackToConnectingAndRecovers()
    {
        ...
        // Rebuilt rather than repaired: a session that has gone away leaves every handle stale, and the next
