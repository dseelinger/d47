...
/// <summary>
/// The caption standard, asserted rather than claimed.
/// </summary>
public class CaptionTests
{
    ...
    /// <summary>Bottom-heavy when nothing better is competing.</summary>
    [Fact]
    ...
    /// <summary>And when they compete, the syntactic break wins.</summary>
    [Fact]
    ...
    public void TheWindowHoldsTwoLinesAndRollsTheOldestOff()
    {
        ...
        // Two, matching the per-event maximum rather than exceeding it.
    ...
    public void CaptionsClearOnTheirOwnAndTheClockStartsWhenTheVoiceStops()
    {
        ...
        // Ten seconds of talking, which is longer than the longest dwell.
    ...
    /// <summary>A caption still sitting there after a silence command is d47 visibly not having stopped.</summary>
    [Fact]
    ...
    /// <summary>One clip is one caption, however many times the audio arbiter mentions it.</summary>
    [Fact]
    ...
    /// <summary>
    /// And the next clip is a new caption even when it says exactly the same thing, which is why this
    /// compares an id rather than the words.
    /// </summary>
    [Fact]
    ...
    /// <summary>A caller with no clip to name still gets a caption.</summary>
    [Fact]
    ...
    /// <summary>
    /// Silence forgets which clip was speaking, so the same one starting again after a shut-up is a
    /// caption rather than a repeat that is swallowed.
    /// </summary>
    [Fact]
    ...
    /// <summary>The dwell is timed against everything still on screen, not only the sentence that just
    /// finished.</summary>
    [Fact]
