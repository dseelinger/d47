...
/// <summary>The line under the microphone indicator.</summary>
public class TheMicrophoneSaysWhatOpensItTests
{
    ...
    /// <summary>Wake mode with no phrase resolved yet.</summary>
    [Fact]
    ...
    /// <summary>
    /// The pre-roll sentence, which is the one that matters most: audio is already being captured, and
    /// this is the only thing that says how briefly it is kept.
    /// </summary>
    [Fact]
    ...
    /// <summary>Every state has an answer, and none of them throws.</summary>
    [Theory]
