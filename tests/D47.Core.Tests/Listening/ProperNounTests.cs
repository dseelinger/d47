...
/// <summary>The names transcription is biased towards.</summary>
public class ProperNounTests
{
    ...
    /// <summary>No Commander at all is no list.</summary>
    [Fact]
    ...
    public void WhereTheCommanderIsAndWhatTheyFlyAreOffered()
    {
        ...
        // These are exactly the words a general-purpose recogniser has never seen, and where it fails
        // silently — a misheard system name comes back as a plausible English phrase.
    ...
    public void TheListIsCappedSoItCannotDisplaceTheModelsOwnContext()
    {
        ...
        // An overlong prompt does not fail loudly — it silently displaces the model's own context and makes
        // transcription worse than no biasing at all.
    ...
    public void VeryShortNamesAreLeftOut()
    {
        ...
        // Two-letter fragments are already in every recogniser's vocabulary and would spend a slot that a
        // real name needs.
