...
/// <summary>Gate policy transitions with no microphone present.</summary>
public class ListenGateTests
{
    ...
    public void AudioFromBeforeTheKeyWasNoticedIsStillCaptured()
    {
        ...
        // 200 ms of speech that happened before the tick loop sampled the key.
    ...
    public void ThePreRollNeverGrowsPastItsWindow()
    {
        ...
        // Ten seconds of room tone while nobody is talking to d47.
    ...
    public void AudioArrivingWhileTheGateIsShutIsNotCapturedTwice()
    {
        ...
        // The second utterance must not begin with the tail of the first.
    ...
    public void AMisPressIsDiscardedRatherThanTranscribed()
    {
        ...
        // Transcribing 80 ms of room tone produces a confident wrong word, which is worse than producing
        // nothing at all.
    ...
    public void ToggleModeStartsOnOnePressAndStopsOnTheNext()
    {
        ...
        // Releasing does nothing in toggle mode — that is the entire difference between the two, and it is a
        // policy over the same gate rather than a second mechanism.
        gate.KeyUp();
    ...
    public void AStuckKeyIsClosedAtTheCeilingAndTheAudioIsKept()
    {
        ...
        // Emitted rather than discarded: they said something, and it is better transcribed late than lost.
        Assert.False(gate.IsListening);
    ...
    public void TheGateReadsNoClockOfItsOwn()
    {
        ...
        // A year of wall-clock could pass here and nothing would happen, because the only time the gate knows
        // is the time it is handed.
