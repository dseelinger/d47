...
public class OrderingIsReachableWithoutTheModelTests
{
    ...
    /// <summary>
    /// The second half of the report: "The just-added item should be the currently selected one." A
    /// Commander who has just said a line is thinking about that line.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Which is what makes the transcript work end to end: a line, and then "put it at the top" in the
    /// next breath, with nothing named in between.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// A line taken off the list takes the selection with it, rather than leaving an id nothing answers
    /// to for the next "move it up" to act on.
    /// </summary>
    [Fact]
    ...
    /// <summary>And with nothing selected, "it" is refused in words that say what to say instead.</summary>
    [Fact]
    ...
    /// <summary>
    /// An item already at the end it was sent to is told which end that is. "Is already where it is"
    /// would be true of every item on the list and would answer nothing.
    /// </summary>
    [Fact]
    ...
    /// <summary>The tool stays off the surface the model can see.</summary>
    [Fact]
    ...
    /// <summary>And it is reachable without one.</summary>
    [Theory]
    ...
    /// <summary>
    /// A phrase is never a bare word. "top" alone would fire on a sentence about the top of a gravity
    /// well, which is the rule the router is phrase-level for.
    /// </summary>
    [Fact]
