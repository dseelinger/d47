...
/// <summary>The Commander's own order.</summary>
public class ChecklistOrderTests
{
    ...
    /// <summary>
    /// The states past Open are next actions rather than badges, which is what <see
    /// cref="ChecklistState"/> asks for in its own summary.
    /// </summary>
    [Theory]
    ...
    /// <summary>Colour is spent only where something is wrong.</summary>
    [Theory]
