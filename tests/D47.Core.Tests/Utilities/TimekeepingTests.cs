...
public class TimekeepingTests
{
    ...
    public void TheGalaxyIsTwelveHundredAndEightySixYearsAhead()
    {
        ...
        // The same day and the same minute.
    ...
    /// <summary>
    /// The galactic date is written the same way for everybody: the galaxy's calendar is not a regional
    /// format, and 08/17 versus 17/08 reads as two different days.
    /// </summary>
    [Fact]
    ...
    public void TheZoneIsAppliedWhenItIsAsked()
    {
        ...
        // The galactic side does not follow it.
    ...
    public void EachKindIsDescribedByTheQuestionItAnswers()
    {
        ...
        // And it never counts up past zero: a timer showing a negative is one that says it is running after
        // it has finished.
