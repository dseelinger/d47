...
/// <summary>The picker opens showing everything it can offer, in words a person can read.</summary>
public class PickerShowsEverythingTests
{
    ...
    public void EveryChoiceIsListedAndTheIdIsNotInTheBox()
    {
        ...
        // And they are actually on screen, not merely in the ItemsSource.
        picker.Show();
    ...
    /// <summary>
    /// Nothing typed still means "keep what I had", which is what makes an empty box safe: the current
    /// value is selected instead of being spelled out.
    /// </summary>
    [AvaloniaFact]
 ...
 /// <summary>A picker with nothing in it says what the row told it, not the generic line.</summary>
    [AvaloniaFact]
