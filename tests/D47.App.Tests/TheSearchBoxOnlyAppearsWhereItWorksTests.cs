...
public class TheSearchBoxOnlyAppearsWhereItWorksTests
{
    ...
    /// <summary>
    /// And it comes back on the way out, rather than the surface losing its search for the rest of the
    /// session because one tab could not use it.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>The settings page is ninety-odd rows and is the reason filtering exists at all.</summary>
    [AvaloniaFact]
