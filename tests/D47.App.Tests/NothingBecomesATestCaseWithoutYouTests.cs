...
public class NothingBecomesATestCaseWithoutYouTests : IDisposable
{
    ...
    /// <summary>
    /// A said row is the other corpus, and the direction alone decides which — a Commander does not
    /// have to know that a mishear and a mispronunciation are filed differently.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// Nothing typed, nothing kept — and the window says which half is missing rather than leaving a
    ...
    /// <summary>The phoneme string is on the pane, in full.</summary>
    [AvaloniaFact]
