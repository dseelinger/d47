...
public class AnIntendedHullDoesNotBlockTheFleetTests
{
    ...
    /// <summary>With the intended hull open, an owned ship still opens.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// Every ship in the fleet is drawn as its own row with its own key, so no two of them can be one
    /// entry — an intended hull keys on its build like the rest.
    /// </summary>
    [Fact]
