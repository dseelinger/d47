...
public class TheEngineerFilterShowsWorkWaitingOnRankTests
{
        ...
        foreach (var line in new[]
                 {
                     ...
                     // Unlocked, and at grade 1 — which is the whole setup: Lei Cheung takes Heavy Duty on a
                     // shield booster to 3, and grade 3 cannot be rolled at rank 1.
    ...
    private static ChecklistService Checklists(CommanderGameState state)
    {
        ...
        // A blueprint and its effect on one slot, the way a promoted build puts them there.
    ...
    public void TheBlueprintIsOnThePageBesideItsEffect()
    {
        ...
        // And the half that was there on its own, which is what made the page read as wrong rather than as
        // empty.
    ...
    /// <summary>
    /// The rest of the list is unchanged: the filter still narrows to this engineer's work, and a line
    /// that is nobody's to roll is still absent.
    /// </summary>
    [AvaloniaFact]
