...
/// <summary>
/// The Transcript readings are named for what a Commander goes there to see rather than for what they
/// are made of.
/// </summary>
public sealed class TheReadingsAreNamedForTheCommanderTests
{
    ...
    /// <summary>The three readings, as the row offers them.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// Both words reach the renamed reading: the label a Commander reads today, and the one they learnt
    /// a year ago.
    /// </summary>
    [AvaloniaTheory]
    [InlineData("in ship")]
