...
/// <summary>Opening the goals band does not push the list off the page.</summary>
public class TheGoalsBandLeavesRoomForTheListTests
{
 ...
 // **The count survives being open**.
    ...
    /// <summary>And the arcs themselves are reachable rather than clipped: what does not fit scrolls.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// A short window is where this bites hardest, and the list still gets a share of it rather than
    /// the band taking everything and leaving a sliver.
    /// </summary>
    [AvaloniaFact]
