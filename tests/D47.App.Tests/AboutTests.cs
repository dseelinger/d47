...
/// <summary>Where the build number lives.</summary>
public class AboutTests
{
    ...
    /// <summary>And the panel no longer spends its best line on either the build or a tagline.</summary>
    [AvaloniaFact]
 ...
 /// <summary>About is an area in the settings nav rather than a button in the footer.</summary>
    ...
    /// <summary>
    /// Frontier's own wording, verbatim, because their media usage rules supply the sentence and ask
    /// that it be somewhere a person can find.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// The changelog ships inside the build, which is what lets the area answer with no internet at all
    /// — the one thing the browser button it replaces could never do.
    /// </summary>
    [Fact]
    public void TheChangelogIsInsideTheBuild()
    {
        ...
        // Newest first, which is the order the file is already written in and the reason the window shows the
        // whole thing rather than hunting for a section.
