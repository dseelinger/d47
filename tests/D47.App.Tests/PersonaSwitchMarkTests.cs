...
/// <summary>
/// Switching core puts a marked line in the conversation, because a transcript that omits the switch
/// reads as one companion changing character mid-page.
/// </summary>
public class PersonaSwitchMarkTests
{
    ...
    public void AMarkIsItsOwnSegmentAndStaysOutOfTheLinesAroundIt()
    {
        ...
        // Three, in order, and only the middle one is marked.
    ...
    /// changing is a thing that happened to the conversation, mid-conversation.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// And the panel draws it in the accent while the conversation around it keeps the colour it had.
    /// </summary>
    [AvaloniaFact]
