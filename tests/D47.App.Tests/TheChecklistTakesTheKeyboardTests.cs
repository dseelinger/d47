...
public class TheChecklistTakesTheKeyboardTests
{
    private static (PanelView Panel, ChecklistService Checklists) Page(params string[] lines)
    {
        ...
        // Adding a line selects it, and these tests are about a page being opened rather than about a Commander
        // having just spoken.
    ...
    /// <summary>One answer in a chooser.</summary>
    ...
    {
        // Descendants come out outermost first, so Last is the card rather than the pane or the scroller
        // around it.
    ...
    /// <summary>The defect, as a Commander meets it: there is no way to change what a line says.</summary>
    [AvaloniaFact]
    ...
    /// <summary>And the prompt it opens is writable: this is the one surface with a keyboard and a clipboard in front of it.</summary>
    [AvaloniaFact]
    ...
    /// <summary>Deleting asks first, and keeping is the answer that costs nothing.</summary>
    [AvaloniaFact]
