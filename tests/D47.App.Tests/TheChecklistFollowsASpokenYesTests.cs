...
public class TheChecklistFollowsASpokenYesTests
{
    ...
    /// <summary>The whole report, from the Suggestions page the Commander was looking at.</summary>
    [AvaloniaFact]
    ...
    /// <summary>And the count on the button that opened it, which was still offering one.</summary>
    [AvaloniaFact]
