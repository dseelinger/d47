...
/// <summary>
/// The link the update prompt opens comes out of a network response and is handed to the shell, so what
/// it is allowed to be is a security property rather than a formatting one.
/// </summary>
public class UpdateCheckerTests
{
    ...
    // The right page over the wrong scheme, and schemes that are not the web at all.
