...
public sealed class ThePanesMoveWhereYouWantThemTests
{
    ...
    /// <summary>The safety property, and the reason this phase is the window's alone.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// <c>MinimumPaneWidth</c> is the clamp on the drag as well as on the reflow, and it has to be the
    ...
    /// <summary>And the surface with no mouse buys no layout constraint for a control it never draws.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// The record is read back through validation, because the file it comes from is one a Commander
    /// can edit.
    /// </summary>
    [Theory]
