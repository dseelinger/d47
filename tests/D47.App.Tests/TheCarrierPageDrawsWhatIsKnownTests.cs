...
public class TheCarrierPageDrawsWhatIsKnownTests
{
    ...
    /// <summary>Bought and switched off is said separately from open for business.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// The squadron's carrier is drawn under its own heading, and never mixed with the Commander's own.
    /// </summary>
    [AvaloniaFact]
    public void TheSquadronsCarrierIsDrawnApartAndSaidToBeTheirs()
    {
        ...
        // can, is a figure waiting to be misread.
        Assert.DoesNotContain("9,999", text, StringComparison.Ordinal);
    }

    /// <summary>
    /// A Commander with no squadron carrier is told nothing about one. d47 cannot tell "no squadron"
    /// from "not seen yet", and saying either would be a claim it cannot support.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// "d47 has not seen one" is a different claim from "you have none", and only the first is
    /// something d47 can know before the management panel has ever been opened.
    /// </summary>
    [AvaloniaFact]
