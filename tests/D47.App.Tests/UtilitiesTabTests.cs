...
/// <summary>Clocks, timers and alarms as a tab of the panel.</summary>
public class UtilitiesTabTests
{
    ...
    /// <summary>Both clocks, from one instant.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
 /// A tick that changes only the countdown does not rebuild the row.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>Cancelling is the Commander's, and the panel is one of the two places that can.</summary>
    [AvaloniaFact]
