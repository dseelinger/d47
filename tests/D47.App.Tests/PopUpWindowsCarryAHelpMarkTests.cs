...
public sealed class PopUpWindowsCarryAHelpMarkTests
{
    ...
    /// <summary>And the page it names is written, with a band.</summary>
    [Fact]
    ...
    /// <summary>
    /// The spend receipt goes to the running totals rather than the top of the Language model page,
    ...
    public void TheSpendMarkNamesTheRunningTotals()
    {
        ...
        // And the anchor is a heading that page actually declares — an anchor that resolves to nothing lands
        // a Commander at the top with no sign anything went wrong.
