...
/// <summary>
/// Reading the label out of the version stamp — the one fact that separates a build somebody published
/// from a build somebody made.
/// </summary>
public class BuildLabelTests
{
    ...
    /// <summary>
    /// A published build carries none: the release workflow builds with the tag's bare version, so this
    /// is what every signed <c>d47.exe</c> in the field looks like.
    /// </summary>
    [Theory]
