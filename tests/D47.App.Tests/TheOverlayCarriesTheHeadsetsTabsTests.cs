...
public class TheOverlayCarriesTheHeadsetsTabsTests
{
    ...
    /// <summary>The tab the instruction named, reachable and drawn — not merely registered.</summary>
    [AvaloniaFact]
    ...
    /// <summary>Settings is the exclusion, and it is the only one.</summary>
    [AvaloniaFact]
    public void SettingsIsRefusedInMiniEvenWhenTheSurfaceHasIt()
    {
        ...
        // Asserted on where the surface ends up rather than on what the navigator returned.
    ...
    /// <summary>
    /// A picture of the checklist at the strip's size, because selectable and readable are two claims
    /// and only one of them can be asserted.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// One headset surface and one strip, wired from the same services the composition root wires them
