...
/// <summary>The affordance that starts a donation, and the two pages it belongs on.</summary>
public class TheDonateButtonIsOnlyWhereItCanWorkTests
{
    ...
    /// <summary>
    /// The two diagnostic readings are the two halves of an incident — Elite's events, and what d47 did
    /// with them.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// And not on In Ship, which is the conversation — the log already holds a more exact copy of it,
    /// so there is nothing here the other readings would not cut better.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// Furnished rather than branched, and here that is a safety property rather than a convention: the
    /// review step is the whole of the consent, and the headset has neither a clipboard to put the
    /// result on nor a file picker to write it with.
    /// </summary>
    [AvaloniaFact]
