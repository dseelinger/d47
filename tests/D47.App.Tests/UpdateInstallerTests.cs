...
public class UpdateInstallerTests
{
    ...
    /// <summary>
    /// A native library the new build no longer ships is retired, not left in place: Whisper's loader
    ...
    public void AFailedInstallPutsTheWholeRunningBuildBack()
    {
        ...
        // The exe is swapped last, so holding it open fails the swap after the native library has already
        // been replaced — exactly the case the rollback exists for.
