...
/// <summary>
/// Power and jump range at the head of a ship's slot list, and the coin on a module a pledge is needed
/// to buy.
/// </summary>
public class GaugesAtTheHeadOfTheSlotListTests
{
    ...
    private static Surface Open(bool pledged = false)
    {
        ...
        // The Elite palette, because the gauges are drawn in themed colours and an unthemed run paints them
        // with a null brush — which looks exactly like a bar that failed to lay out.
    ...
    /// <summary>
    /// A Cobra Mk V the Commander is sitting in: a plant, a drive, a hardpoint and a shield booster, so
    /// both halves of the power split have something to be about.
    /// </summary>
    ...
    {
        // **The one failure only an eye catches**: a glyph the shipped font lacks draws as a box, and a box
        // beside a module name reads as a rendering bug rather than as a gate.
    ...
    public void AModuleBehindAPledgeCarriesTheCoinOnItsRow()
    {
        ...
        // A Prismatic Shield Generator: one of the nineteen, and the eight sizes of it are the whole of the
        // family that is gated.
        surface.Ships.Plan(
            build.Id,
    ...
    public void AQuestionAboutSomethingElseDoesNotLandOnTheShipsTab()
    {
        ...
        // An engineer-unlock chain proposes plan items from the same source and scopes them to the universal
        // list.
