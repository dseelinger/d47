...
public sealed class RequiredFieldsAreMarkedTests
{
    ...
    /// <summary>The third state gets a shape of its own rather than a second asterisk.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// A ship-supplied placeholder quotes the figure d47 would actually use, and follows it when it
    /// changes — a placeholder naming the ship a Commander was flying an hour ago is worse than the
    /// bare phrase, because the phrase was never wrong.
    /// </summary>
    [AvaloniaFact]
    ...
    /// <summary>No value, no parenthesis.</summary>
    [AvaloniaTheory]
    [InlineData(null)]
    [InlineData("")]
