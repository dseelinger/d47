...
public class EdgeProtocolTests
{
    ...
    {
        // Journal content is untrusted, and a Commander can name a ship whatever they like.
    ...
    /// <summary>
    /// MP3 is not a choice: the endpoint removed its raw-PCM formats in mid-2026 and closes the socket
    /// with "Unsupported Edge output format" for them. 24 kHz mono is pinned because the decoder
    /// rejects any other shape rather than resampling around it.
    /// </summary>
    [Fact]
    ...
    /// <summary>Getting this wrong halves or doubles the pitch of every word the app says.</summary>
    [Fact]
    public void UpsamplingDoublesTheLengthAndKeepsTheOriginalSamplesInPlace()
    {
        ...
        // The final sample holds rather than ramping to zero, which would click at the end of every sentence.
