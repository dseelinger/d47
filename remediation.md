...
- [ ] **1. The first hardpoint row is a column of single letters.** Reported with a picture: under
...
- [ ] **2. "Broo Tarquin is still three steps out."** An opening fact of that kind is not useful.

- [ ] **3. A stale fact spoken in the present tense.** *"Sacred Fire is mid-manoeuvre — a jump
