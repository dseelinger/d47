...
A module bought with Merc Coins reads with its Merc Coin price — *"Bought a Cargo Rack for 40 Merc
Coins"* — rather than dropping the cost because Frontier zeroes the credit price for that purchase.
Buying a module and storing it straight away names its price the same way, in whichever currency
paid for it.
