...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">It answers with the materials per roll, not just per grade.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">What you are missing lands on the Gap page as a ledger.</text>
</svg>
</section>
<section>
...
The grade is finished at 1.0, where 0.85 is as far as the game requires.
