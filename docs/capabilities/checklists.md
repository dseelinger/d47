...
<svg viewBox="0 0 880 300" role="img" aria-label="Open items above the line, finished items kept below it">
 ...
 <text x="806" y="224" text-anchor="end" font-size="16" fill="var(--text-muted)">is most of the point</text>
 <text x="440" y="288" text-anchor="middle" font-size="16" fill="var(--text-muted)">Deleting is a different act — that one is changing your mind.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 340" role="img" aria-label="D47 writes proposals to its own file and only you can move something into the real list">
 ...
 <text x="650" y="160" font-size="17" font-weight="700" fill="var(--accent)">unreachable</text>
 <text x="650" y="186" font-size="17" font-weight="700" fill="var(--accent)">from the AI.</text>
 <text x="440" y="308" text-anchor="middle" font-size="16" fill="var(--text-muted)">Your journal and your comms panel are text D47 did not write, and anything it can call,</text>
 <text x="440" y="330" text-anchor="middle" font-size="16" fill="var(--text-muted)">a hostile message can try to call. The worst that reaches you is a proposal you decline.</text>
</svg>
</section>
</div></div>
</details>
...
<div class="cards">
<a class="card" href="engineers.html"><span class="ct">Engineers →</span><span class="cd">Where a route comes from before it lands here, one line per stop.</span></a>
<a class="card" href="ships.html"><span class="ct">Ships →</span><span class="cd">Where a ship build is planned, which is what fills half this list.</span></a>
<a class="card" href="colonisation.html"><span class="ct">Colonisation →</span><span class="cd">Construction sites, and the other half.</span></a>
</div>
</div>
</div></div>
