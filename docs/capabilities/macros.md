...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">They run in order, with a pause between each.</text>
</svg>
</section>
<section>
...
A bad macro is never silently dropped — that would leave you saying a phrase with nothing to act on it for a
