...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">Say the range and the hold and it solves for the ship you are in.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 208" role="img" aria-label="The Checklist tab">
 ...
 <text x="44" y="130" font-size="16" fill="var(--text)">2. Jump to Skaudai CH-B d14-34</text>
 <text x="44" y="184" font-size="15" fill="var(--text-muted)">One line per stop, ticked as you fly them.</text>
</svg>
</section>
<section>
...
**This page describes a route. It drives nothing.** What comes back is the route itself — the
jumps, the waypoints, where to supercharge — read out to you. Nothing here touches the galaxy map.
If what you want is the course actually set in the game, that is [navigation](navigation.md), which
opens the map and plots it.

**Say "neutron" when you want this one.** The neutron plot is the thing this page has that the
galaxy map has not: a route that routes you through jet cones and supercharges on the way, which
the map will not work out for you. "Plot neutron jumps to my carrier" describes that route. Every
other way of asking — "set course for my carrier", "plot a course to my carrier", and plain "route
to my carrier" — plots in the map instead, because that is what a Commander means by it.
...
**One question asks somewhere else.** *Where do I buy this* and *where do I sell this* — the
commodity search on the [galaxy page](galaxy.html#find_nearest_station) — read
[Ardent Insight](https://ardent-insight.com) instead since
[#350](https://github.com/dseelinger/d47/issues/350), because it applies each EDDN message as it
arrives and a Community Goal rush moves a market faster than a station index is rebuilt. A **trade
route** is not that question and still comes from spansh, whose search returns whole markets for
every station at once, which is what a route needs and what one commodity's index cannot give.
