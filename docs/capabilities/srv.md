...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">The same shape as the ship switches, pointed at the buggy.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 176" role="img" aria-label="The ask row with a question typed into it">
 ...
 <text x="20" y="152" font-size="16" fill="var(--text-muted)">D47 cannot tell you where the ship will land — that is the game's decision.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 226" role="img" aria-label="Switches can be pressed but axes like steering and turret aim have no press to send">
 ...
 <text x="440" y="198" text-anchor="middle" font-size="17" font-weight="700" fill="var(--accent)">It can turn the turret on. It cannot point it.</text>
</svg>
</section>
<section>
...
<svg viewBox="0 0 880 222" role="img" aria-label="Getting in and out of the SRV goes through the role panel, so there is no key for it">
 ...
 <text x="440" y="180" text-anchor="middle" font-size="16" fill="var(--text)">From there, “down”, “right” and “select” walk you to it.</text>
...
<div class="cards">
<a class="card" href="flight-controls.html"><span class="ct">Flight and navigation →</span><span class="cd">The switch that has to be on first, and what happens on a joystick.</span></a>
<a class="card" href="panels.html"><span class="ct">Panels →</span><span class="cd">Walking the role panel, which is how you get in and out.</span></a>
<a class="card" href="on-foot.html"><span class="ct">On foot →</span><span class="cd">What Directive 47 knows once you have left the buggy behind.</span></a>
</div>
</div>
</div></div>
