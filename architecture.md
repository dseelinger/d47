...
> **Amended 2026-08-18, and scheduled as Phase 29.** "Two implementations ship" has been written in the present tense since Phase 1 and only one of them exists. It stays as the design, and the paragraph below it is now the plan: [docs/plans/phase-29-bring-your-own-model.md](docs/plans/phase-29-bring-your-own-model.md).
>
