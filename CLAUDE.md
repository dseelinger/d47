...
- **Phase numbers are references, and phases 1-21 are frozen.** Several hundred code comments cite
  ...
  Phase 15 did so at 22 citations across 18 files, Phase 21 on 2026-08-16 — and the set only ever
  grows.
